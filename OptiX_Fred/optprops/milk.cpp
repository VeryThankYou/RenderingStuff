...
void unhomogenized_milk(Medium& m, double fat_weight,     // milk fat weight-%
...
{
  homogenized_milk(m, fat_weight, protein_weight, 0.0, casein_r_vs, casein_c_s);
}

void homogenized_milk(Medium& m, double fat_weight,     // milk fat weight-%
                        double protein_weight, // protein weight-%
                        ...
                        double casein_c_s)     // radius standard deviation of casein micelles
{
  ...
  milk(m, fat_weight, protein_weight, fat_r_vs, fat_c_s, casein_r_vs, casein_c_s);
}

void milk(Medium& m, double fat_weight,      // milk fat weight-%
            double protein_weight,  // protein weight-%
            ...
            double casein_c_s)      // radius standard deviation of casein micelles
{
  ...
  casein.dr = 1.0e-9;
  milk(m, fat, casein, fat_weight, protein_weight);
}

void milk(Medium& m, LogNormalParticleDistrib& fat,    // Distribution of fat globules
